...
$.ajax({
  type: "POST",
  url: "http://thewatchguard.com/alpha/slim-cor/chat_cor.php?loginistant="+loginistant+"&verification_user_id="+verification_user_id+"&qualification_id="+qualification_id,
