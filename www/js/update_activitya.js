...
$.ajax({url: 'http://thewatchguard.com/alpha/slim-cor/count.php?region_num='+region_num,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({
  type: "POST",
  url: "http://thewatchguard.com/alpha/slim-cor/chat.php?loginistant="+loginistant+"&verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&status_val_inpro="+status_val_inpro+"&sdocument="+sdocument+"&remarkg="+remarkg+"&qualification_id="+qualification_id,
